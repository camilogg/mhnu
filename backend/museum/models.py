...
from museum.validators import catalog_number_regex, occurrence_id_regex, validate_date
...
class Record(models.Model):
    ...
    class GeoreferenceVerificationStatus(models.TextChoices):
        ...
        VERIFIED_BY_DATA_PROVIDER = "Verificado por el proveedor de los datos", _(
    ...
    license = models.CharField(_("license"), max_length=255, blank=True, null=True)
    ...
    collection_code = models.ForeignKey(
        CollectionCode, on_delete=models.CASCADE, verbose_name=_("collection code")
    )
    ...
    basis_of_record = models.ForeignKey(
        BasisOfRecord, on_delete=models.CASCADE, verbose_name=_("basis of record")
    )
    ...
    occurrence_ID = models.CharField(
        _("occurrence ID"),
        max_length=255,
        validators=[occurrence_id_regex],
        unique=True,
    )
    ...
    organism_remarks = models.TextField(_("organism remarks"), blank=True, null=True)
    individual_count = models.PositiveSmallIntegerField(_("individual count"))
    sex = models.ForeignKey(
        Sex, on_delete=models.CASCADE, verbose_name=_("sex"), blank=True, null=True
    )
    ...
    behavior = models.CharField(_("behavior"), max_length=255, blank=True, null=True)
    ...
    # Event fields
    event_ID = models.CharField(_("event ID"), max_length=255, blank=True, null=True)
    ...
    island = models.CharField(_("island"), max_length=255, blank=True, null=True)
    ...
    minimum_distance_above_surface_in_meters = models.CharField(
        _("minimum distance above surface in meters"),
        max_length=255,
        blank=True,
        null=True,
    )
    maximum_distance_above_surface_in_meters = models.CharField(
        _("maximum distance above surface in meters"),
        max_length=255,
        blank=True,
        null=True,
    )
    ...
    location_remarks = models.TextField(_("location remarks"), blank=True, null=True)
    ...
    decimal_latitude = models.FloatField(_("decimal latitude"), blank=True, null=True)
    decimal_longitude = models.FloatField(_("decimal longitude"), blank=True, null=True)
    geodetic_datum = models.CharField(
        _("geodetic datum"), max_length=255, default="WGS84", null=True, blank=True
    )
    ...
    georeferenced_by = models.TextField(_("georeferenced by"), blank=True, null=True)
    georeferenced_date = models.CharField(
        _("georeferenced date"),
        max_length=255,
        blank=True,
        null=True,
        validators=[validate_date],
    ...
    georeference_verification_status = models.CharField(
        _("georeference verification status"),
        max_length=255,
        blank=True,
    ...
    earliest_eon_or_lowest_eonothem = models.CharField(
        _("earliest eon or lowest eonothem"), max_length=255, blank=True, null=True
    )
    latest_eon_or_highest_eonothem = models.CharField(
        _("latest eon or highest eonothem"), max_length=255, blank=True, null=True
    )
    earliest_era_or_lowest_erathem = models.CharField(
        _("earliest era or lowest erathem"), max_length=255, blank=True, null=True
    )
    latest_era_or_highest_erathem = models.CharField(
        _("latest era or highest erathem"), max_length=255, blank=True, null=True
    )
    earliest_period_or_lowest_system = models.CharField(
        _("earliest period or lowest system"), max_length=255, blank=True, null=True
    )
    latest_period_or_highest_system = models.CharField(
        _("latest period or highest system"), max_length=255, blank=True, null=True
    )
    earliest_epoch_or_lowest_series = models.CharField(
        _("earliest epoch or lowest series"), max_length=255, blank=True, null=True
    )
    latest_epoch_or_highest_series = models.CharField(
        _("latest epoch or highest series"), max_length=255, blank=True, null=True
    )
    earliest_age_or_lowest_stage = models.CharField(
        _("earliest age or lowest stage"), max_length=255, blank=True, null=True
    )
    latest_age_or_highest_stage = models.CharField(
        _("latest age or highest stage"), max_length=255, blank=True, null=True
    )
    lowest_biostratigraphic_zone = models.CharField(
        _("lowest biostratigraphic zone"), max_length=255, blank=True, null=True
    )
    highest_biostratigraphic_zone = models.CharField(
        _("highest biostratigraphic zone"), max_length=255, blank=True, null=True
    )
    lithostratigraphic_terms = models.CharField(
        _("lithostratigraphic terms"), max_length=255, blank=True, null=True
    )
    group = models.CharField(_("group"), max_length=255, blank=True, null=True)
    formation = models.CharField(_("formation"), max_length=255, blank=True, null=True)
    member = models.CharField(_("member"), max_length=255, blank=True, null=True)
    ...
    identification_verification_status = models.CharField(
        _("identification verification status"), blank=True, max_length=255, null=True
    )
    ...
    # Taxon fields
    taxon_ID = models.CharField(_("taxon ID"), max_length=255, blank=True, null=True)
    ...
    name_according_to = models.TextField(_("name according to"), blank=True, null=True)
    name_published_in = models.TextField(_("name published in"), blank=True, null=True)
    ...
    _class = models.ForeignKey(
        Class, on_delete=models.CASCADE, verbose_name=_("class"), blank=True, null=True
    )
    order = models.ForeignKey(
        Order, on_delete=models.CASCADE, verbose_name=_("order"), blank=True, null=True
    )
    ...
    genus = models.ForeignKey(
        Genus, on_delete=models.CASCADE, verbose_name=_("genus"), blank=True, null=True
    )
    subgenus = models.CharField(_("subgenus"), max_length=255, blank=True, null=True)
    ...
    def clean(self):
        if not str(self.catalog_number).startswith(self.collection_code.name):
            raise ValidationError(
                {
                    "catalog_number": _(
                        "Should start with the collection code: {}"
                    ).format(self.collection_code.name)
                }
            )
