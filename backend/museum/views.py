...
def record_detail_pdf(request, pk):
    ...
    HTML(
        string=html_string, base_url=settings.HOST_URL, url_fetcher=django_url_fetcher
...
def record_list_pdf(request, queryset):
    ...
    html_string = render_to_string(
        "museum/record_list_pdf.html",
        {"records": queryset, "collection_code": collection_code},
    )
